<template>
    <div class="images">
        ...
        <div class="logo-kmV">Logo KmV <br>
            <img src="/../../assets/images/kmv.png"></div>
        <div class="duas-garrafas">2 Garrafas <br>
            <img src="/../../assets/images/2garrafas.png"></div>
        <div class="quatro-garrafas">4 Garrafas <br>
